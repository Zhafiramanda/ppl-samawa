    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
          <img src="https://belajargiat.id/wp-content/uploads/2020/12/logo-undip-256x300.png" class="h-8 mr-3" alt="Logo Buku" />
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Sistem Monitoring Akademik Mahasiswa Informatika</span>
        </a>
      </div>
